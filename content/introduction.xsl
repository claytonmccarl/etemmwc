...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    -->
    <!-- The following tells ClaytonPlate which to use. I should be able to work that into the JS as well, but it didn't work as well as I wanted.  Need time to make a more elegant solution. -->
    <xsl:param name="switchCSS" select="concat($filePrefix,'/css/introduction.css')"/>


    <!-- The following creates the CSS switching toolbox. It overrides the same in teibp.xsl. I'm commenting out to prevent toolbox from showing on intro page. CM 20180518-->
  ...
  <!--      <div id="teibpToolbox">
            <div>
                ...
                <div>
                    ...
                    <select style="display:inline;" id="themeBox" onchange="switchTextView(this);">
                        <option value="{$edition}">edited text</option>
                        <option value="{$edition_markup}">edited text with markup</option>
    ...
    <!-- copying out function calls makes title disappear from top of intro page.  -->
